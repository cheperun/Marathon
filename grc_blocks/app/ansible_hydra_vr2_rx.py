...
# Generated: Mon Oct 14 19:36:07 2019
##################################################
...
class ansible_hydra_vr2_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ansibleIP='192.168.5.81', freqrx=2.48e9, freqtx=2.48e9+3e6, gain=0.85, samp_rate=200e3, vr1offset=-300e3, vr2offset=300e3):
