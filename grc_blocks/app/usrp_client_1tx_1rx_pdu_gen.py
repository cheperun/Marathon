...
# Title: Usrp Client 1Tx 1Rx Pdu Gen
# Generated: Thu Jan 17 15:16:56 2019
##################################################
...
class usrp_client_1tx_1rx_pdu_gen(gr.top_block, Qt.QWidget):

    def __init__(self, freqrx=1.1e9, freqtx=1.1e9, hydraClient='192.168.5.52', samp_rate=200e3, vr1offset=-100e3, vr2offset=700e3):
        gr.top_block.__init__(self, "Usrp Client 1Tx 1Rx Pdu Gen")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Usrp Client 1Tx 1Rx Pdu Gen")
        ...
        self.settings = Qt.QSettings("GNU Radio", "usrp_client_1tx_1rx_pdu_gen")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--hydraClient", dest="hydraClient", type="string", default='192.168.5.52',
        help="Set hydraClient [default=%default]")
    return parser


def main(top_block_cls=usrp_client_1tx_1rx_pdu_gen, options=None):
    if options is None:
