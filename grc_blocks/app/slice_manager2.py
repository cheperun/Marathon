...
def main():
    ...
    client1 = hydra.hydra_client("192.168.5.235", 5000, 1, True)
    # We put the IP of the machine running the UE
    ue1 = xmlrpclib.ServerProxy("http://192.168.5.232:8080")
    ...
    if (True):
        # We put the IP of the machine executing this script
        client2 = hydra.hydra_client("192.168.5.235", 5000, 2, True)
        # We put the IP of the machine running the UE
        ue2 = xmlrpclib.ServerProxy("http://192.168.5.238:8080")
