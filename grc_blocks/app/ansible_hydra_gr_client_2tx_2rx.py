...
# Generated: Mon Oct 14 19:34:02 2019
##################################################
...
class ansible_hydra_gr_client_2tx_2rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ansibleIP='192.168.5.84', freqrx=2.48e9+3e6, freqtx=2.48e9, samp_rate=400e3, samp_rate2=200e3, vr1offset=-300e3, vr2offset=300e3):
        ...
        # Blocks
        ##################################################
        self._mul2_range = Range(0, 1.0, 0.01, 0.03, 200)
        ...
        self._mul_range = Range(0, 1.0, 0.01, 0.04, 200)
        ...
        self.hydra_gr_sink_0_0.start_client(freqtx + vr2offset, samp_rate2, 1024)
        self.hydra_gr_sink_0 = hydra.hydra_gr_client_sink(1, ansibleIP, 5000)
        self.hydra_gr_sink_0.start_client(freqtx + vr1offset, samp_rate, 1024)
        self.hydra_gr__source_0_0_0 = hydra.hydra_gr_client_source(2, ansibleIP, ansibleIP, 5000)
        self.hydra_gr__source_0_0_0.start_client(freqrx + vr2offset, samp_rate2, 10000)

        self.hydra_gr__source_0_0 = hydra.hydra_gr_client_source(1, ansibleIP, ansibleIP, 5000)
        self.hydra_gr__source_0_0.start_client(freqrx + vr1offset, samp_rate , 10000)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--ansibleIP", dest="ansibleIP", type="string", default='192.168.5.84',
